...
-- value at index 1 is offset for L1, etc.
ff_const.MP_CURRENT = {0x20,0x21,0x22,0x23,0x24,0x25,0x26,0x27};

-- offsets for member's current MP
ff_const.MP_MAX = {0x28,0x29,0x2A,0x2B,0x2C,0x2D,0x2E,0x2F};
